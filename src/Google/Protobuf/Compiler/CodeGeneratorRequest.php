...
class CodeGeneratorRequest extends \Google\Protobuf\Internal\Message
{
     ...
     *           The generator parameter passed on the command-line.
     *     @type FileDescriptorProto[]|\Google\Protobuf\Internal\RepeatedField $proto_file
     *           FileDescriptorProtos for all files in files_to_generate and everything
     *           they import.  The files will appear in topological order, so each file
     *           appears before any file that imports it.
     *           protoc guarantees that all proto_files will be written after
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, FileDescriptorProto::class);
        $this->proto_file = $arr;
     ...
     *
     * Generated from protobuf field <code>optional .google.protobuf.compiler.Version compiler_version = 3;</code>
     * @return \Google\Protobuf\Compiler\Version|null
     */
